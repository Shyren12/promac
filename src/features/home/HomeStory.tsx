          ...
          <div className="flex flex-col items-center gap-[32px] w-full">
            ...
            <div className="flex flex-col items-center gap-[24px] w-full ">
              ...
              <p className="font-inter font-normal text-[15px] leading-[18px] text-[#000000] ">
                ...
                cận với sự tận tâm và chuyên nghiệp.
                <br />
                Được thành lập với tầm nhìn mang đến các giải pháp in ấn chất
                lượng cao, chúng tôi đã phát triển và trở thành một thương hiệu
                đáng tin cậy trong ngành in ấn.
                <br />
                <br />
